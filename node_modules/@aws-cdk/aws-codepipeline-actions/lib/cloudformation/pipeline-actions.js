...
class CloudFormationDeployAction extends CloudFormationAction {
    ...
    bound(scope, stage, options) {
        ...
        const providedCapabilities = (_a = this.props2.cfnCapabilities) !== null && _a !== void 0 ? _a : (_b = this.props2.capabilities) === null || _b === void 0 ? void 0 : _b.map(c => {
            switch (c) {
